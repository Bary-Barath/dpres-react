...
const QUESTIONS = [
  ...
  { id: 9, q: 'Where is the safest place to shelter during a severe cyclone?', options: ['Near windows to monitor the storm', 'An interior room away from windows on a lower floor', 'On the rooftop to avoid storm surge', 'In your car ready for a quick evacuation'], answer: 1, explanation: 'An interior room on a lower floor, away from windows, protects you from flying debris and high winds during a cyclone.' },
