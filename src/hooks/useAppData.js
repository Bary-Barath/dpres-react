...
const DEFAULT_STUDENTS = [
  ...
  { id: 's-002', name: 'Priya Sharma',     rollNo: 'CS21002', dept: 'Computer Science',            year: '3rd Year', email: 'priya.sharma@campus.edu',    role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 96, certStatus: 'Certified'    },
  ...
  // AI & Data Science
  { id: 's-005', name: 'Arjun Nair',       rollNo: 'AI22001', dept: 'AI & Data Science',           year: '2nd Year', email: 'arjun.nair@campus.edu',      role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 95, certStatus: 'Certified'    },
  ...
  { id: 's-008', name: 'Meera Joshi',      rollNo: 'IT21001', dept: 'Information Technology',      year: '3rd Year', email: 'meera.joshi@campus.edu',     role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 92, certStatus: 'Certified'    },
  ...
  { id: 's-012', name: 'Pooja Iyer',       rollNo: 'EC21002', dept: 'Electronics & Communication', year: '3rd Year', email: 'pooja.iyer@campus.edu',      role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 98, certStatus: 'Certified'    },
  ...
  { id: 's-015', name: 'Manish Tiwari',    rollNo: 'ME21001', dept: 'Mechanical Engineering',      year: '3rd Year', email: 'manish.tiwari@campus.edu',   role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 88, certStatus: 'Certified'    },
  ...
  // Civil Engineering
  { id: 's-018', name: 'Kavya Nambiar',    rollNo: 'CE21001', dept: 'Civil Engineering',           year: '3rd Year', email: 'kavya.nambiar@campus.edu',   role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 90, certStatus: 'Certified'    },
  ...
  // Biotechnology
  { id: 's-021', name: 'Ishaan Malhotra',  rollNo: 'BT21001', dept: 'Biotechnology',              year: '3rd Year', email: 'ishaan.malhotra@campus.edu', role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 94, certStatus: 'Certified'    },
  ...
  { id: 's-025', name: 'Nikhil Jain',      rollNo: 'CS23001', dept: 'Computer Science',            year: '1st Year', email: 'nikhil.jain@campus.edu',     role: 'student', completedModules: ['fire','flood','quake','threat'],  status: 'Active',   pts: 800, prepScore: 91, certStatus: 'Certified'    },
];
